...
public class GenderDetector {
     ...
     * <p> Obs.: This function only works in "<b>Brazilian Portuguese</b>" names. </p>
     *
     * @param fullName Full name to analyze. Surname will be ignored automatically.
     * @return [-1] - Invalid <br> [ 0] - Undefined <br> [ 1] - Feminine <br> [ 2] - Masculine
     * @throws IndexOutOfBoundsException If the algorithm tries to access an invalid position in the name.
     */
    public static int detect(final String fullName) throws IndexOutOfBoundsException {
        final String name = fullName.trim().split(" ")[0].toLowerCase();
