 ...
 * Tests for the {@link BrazilianDetector} class.
 * </p>
 *
...
class BrazilianDetectorTest {

    private final Detector detector = new BrazilianDetector();

    @Test
    @DisplayName("Detect: Throws 'IllegalArgumentException' when name is null")
    void detect_001() {
